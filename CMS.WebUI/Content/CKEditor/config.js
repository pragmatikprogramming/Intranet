...
CKEDITOR.editorConfig = function( config ) {
	...
	//config.doksoft_include_css = ['/Content/css/Admin/ckeditorStyles.css'];
	config.doksoft_include_css = ['/Content/css/allCKE.css'];
