...
<script runat="server">
	...
	public override bool CheckAuthentication()
	{
        ...
        if(CMS.Domain.HelperClasses.SessionHandler.is_user_authenticated(uid))
        {
            return true;
        }
	...
	public override void SetConfig()
	{
		...
		BaseDir = "C:\\Users\\jwigginton.ENCINITAS\\Documents\\GitHub\\Intranet\\CMS.WebUI\\";
		...
		type = ResourceType.Add( "Documents" );
		type.Url = BaseUrl + "Documents/";
		type.Dir = BaseDir == "" ? "" : BaseDir + "Documents/";
		type.MaxSize = 0;
		type.AllowedExtensions = new string[] { "bmp", "csv", "doc", "docx", "gif", "jpeg", "jpg", "pdf", "png", "ppt", "pptx", "xls", "xlsx" };
		type.DeniedExtensions = new string[] { };

		type = ResourceType.Add( "Images" );
		type.Url = BaseUrl + "Galleries/";
		type.Dir = BaseDir == "" ? "" : BaseDir + "Galleries/";
		type.MaxSize = 0;
